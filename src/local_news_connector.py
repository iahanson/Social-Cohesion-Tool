...
class LocalNewsConnector:
    ...
    def __init__(self, data_file: str = "data/england_local_news_batch100_full_completed.csv"):
        ...
        self.repopulate_news_agent = True
    ...
    def load_data(self) -> bool:
        ...
        try:
            ...
            if self.repopulate_news_agent==True:
                self.news_data_add=run_agent(self._lad_mapping_cache['LAD23NM'], inter_lad_sleep=2.5)
                self.news_data=pd.concat([self.news_data,self.news_data_add],ignore_index=True)
            # Clean column names
